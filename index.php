<?php include "../homeland/includes/header.php";
?>
            ...
            <div class="container py-1">
                <div class="row align-items-center">
                    <div class="col-8 col-md-8 col-lg-4">
                        <h1 class="mb-0"><a href="index.php" class="text-white h2 mb-0"><strong>DreamHome<span
                    ...
                    <div class="col-4 col-md-4 col-lg-8">
                        <nav class="site-navigation text-right text-md-right" role="navigation">
                            ...
                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li><a href="<?php echo APPURL; ?>/auth/contact.php">Contact</a></li>
...
?>
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown arrow-top">
                                        <li><a href="<?php echo APPURL; ?>">Logout</a></li>


                                    </ul>
                                </li>
                                <?php else: ?>
                                <a href="<?php echo APPURL;?>/auth/login.php">Login</a></li>
    ...
    <div class=" slide-one-item home-slider owl-carousel">
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(/images/img1.jpg);" data-aos="fade"
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(/images/img2.jpg);" data-aos="fade"
            data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
            ...
            <div class="row mb-5">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <h2 class="property-title"><a href="property-details.html">625 S. Berendo
                                    St</a></h2>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <h2 class="property-title"><a href="property-details.html">871 Crenshaw
                                    Blvd</a></h2>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        ...
                        <div class="p-4 property-body">
                            <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                            <h2 class="property-title"><a href="property-details.html">853 S Lucerne
                                    Blvd</a></h2>
                            <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis maiores
                        quisquam saepe
                        architecto error corporis aliquam. Cum ipsam a consectetur aut sunt sint animi,
                        pariatur
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <a href="#" class="service text-center">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt iure qui
                            natus
                            perspiciatis
                            ex odio molestia.</p>
            ...
            <div class="row mb-5 justify-content-center">
                <div class="col-md-7">
                    <div class="site-section-title text-center">
                        <h2>Our Agents</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero magnam
                            officiis ipsa eum
                            pariatur labore fugit amet eaque iure vitae, repellendus laborum in modi
                            reiciendis
                            quis!
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <div class="text">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi dolorem
                                totam non quis
                                facere blanditiis praesentium est. Totam atque corporis nisi, veniam
                                non. Tempore
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <div class="text">
                            ...
                            <span class="d-block mb-3 text-white-opacity-05">Real Estate Agent</span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis, cumque
                                vitae
                                voluptates
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <div class="text">
                            ...
                            <span class="d-block mb-3 text-white-opacity-05">Real Estate Agent</span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores illo
                                iusto,
                                inventore,
                                iure dolorum officiis modi repellat nobis, praesentium perspiciatis,
                                explicabo.
                                Atque
    ...
    <!-- include footer -->
    <?php
include "../homeland/includes/footer.php";?>